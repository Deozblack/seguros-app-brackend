  ...
  attributes: {
    components: Attribute.DynamicZone<
      [
        ...
        'contents.content-carrousel-info',
        'components.content-aling-text',
        'contents.content-team-list'
      ]
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiBlogDetailBlogDetail extends Schema.CollectionType {
  ...
  attributes: {
    ...
    description_preview: Attribute.Text;
    editor: Attribute.RichText &
      ...
      >;
    uid: Attribute.UID<'api::blog-detail.blog-detail', 'title'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiContactFormContactForm extends Schema.CollectionType {
  ...
  attributes: {
    ...
    services: Attribute.Enumeration<
      [
        'P\u00F3lizas de Seguros de Vida Personalizadas',
